...
```{r}
setwd("C:/Users/D_b_mt/OneDrive - Manipal Academy of Higher Education/Documents/Coursera/course project")
traincsv <- read.csv("./data/pml-training.csv")
testcsv <- read.csv("./data/pml-training.csv")
